...
function Booking() {
  ...
  const [stateBookings, setStateBookings] = useState(bookings);
  ...
  return (
    <div className='container mx-auto min-h-[80vh]'>
      {stateBookings &&
        stateBookings.map((booking, index) => (
          <div
            key={index}
            className='max-w-screen-lg ml-10 mt-8 p-10 bg-white border border-gray-200 rounded-lg shadow-md shadow-[#E99B04] dark:bg-gray-800 dark:border-gray-700'
          >
            ...
            <div className='flex justify-end'>
              <button
                type='button'
                className='px-5 py-2.5 mr-2 mb-2 text-sm font-medium text-black bg-[#E99B04] rounded-lg focus:outline-none hover:bg-yellow-500 focus:ring-2 focus:ring-yellow-400 dark:bg-yellow-600 dark:hover:bg-yellow-600 dark:focus:ring-yellow-700
         '
