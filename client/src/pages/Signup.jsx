...
const Login = () => {
  return (
    <div className='bg-white py-4 mx-5 rounded-3xl mb-1 mt-1'>
        <div className='bg-[#160194] opacity-80 w-[50%] h-[60%] rounded-3xl flex flex-col items-center ml-auto mr-auto mt-1 p-20'>
          <form className='bg-white shadow-lg rounded-3xl px-8 pt-6 pb-6 mb-4 w-full'>
            ...
            <div className="mb-1">
              ...
              <input type="email" className="shadow appearance-none border border-[#160194] rounded-3xl w-full py-2 px-3 text-black mb-3 leading-tight focus:outline-none focus:shadow-outline" placeholder='Email' />
            </div>
            <div className="mt-1">
