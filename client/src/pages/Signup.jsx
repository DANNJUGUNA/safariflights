    ...
    <div className='bg-[#E99B04] opacity-80 w-[70%] h-[90%] flex flex-col items-center ml-auto mr-auto mt-2 p-20'>
      <form className='bg-white shadow-md rounded px-8 pt-6 pb-6 mb-4 w-full'>
        ...
        <div className="mt-4">
          ...
          <input type="email" className="shadow appearance-none border-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder='Email' />
        </div>
        <div className="mt-4">
