    ...
    <div className='bg-[#E99B04] opacity-80 w-[70%] h-[90%] flex flex-col items-center ml-auto mr-auto mt-2 p-20'>
      <form className='bg-white shadow-md rounded px-8 pt-6 pb-6 mb-4 w-full'>
        ...
        <div className="mb-6 mt-4">
          ...
          <input type="password" className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" />
          <p className="text-red-500 text-xs italic">Please enter your password</p>
        </div>
        <div className="flex items-center justify-between">
          <button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Login</button>
